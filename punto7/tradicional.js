...
mensajeen consola avisando que han despegado Configure la rutina 
necesaria para despegar la nave utilizando callback
*/
...
filtrarPlanos(planos,function(filtro){
    ...
    if(cuenta>0){
        console.log("Arrancando la nave Fuimonos Chewy")
    }else{
        console.log("Nos quedamos ahora donde dejaste ese holocron")
    }
})